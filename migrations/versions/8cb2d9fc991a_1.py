...
Revision ID: 8cb2d9fc991a
Revises: 
Create Date: 2025-10-22 08:26:54.238686
...
def upgrade():
    ...
    sa.Column('expiry', sa.String(length=200), nullable=True),
    ...
    sa.Column('standards', sa.String(length=200), nullable=True),
